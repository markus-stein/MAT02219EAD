...
*"Toda função de variáveis aleatórias (v.a.s) é aleatória."*
...
Definição **Erro padrão**: é o desvio padrão de uma estatística. Por exemplo *erro padrão da média* $\sigma_{\overline X} = \sqrt{Var(\overline X)}$.
