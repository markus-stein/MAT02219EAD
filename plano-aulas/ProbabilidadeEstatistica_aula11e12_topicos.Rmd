...
* Porque usar modelos de distribuição de probabilidades? Facilitam nos cálculos quando os problemas se encaixam em modelos (paramétricos);
    ...
    + saberemos funções de probabilidade e distribuição, esperança, variância, ..., mais rapidamente.
    + **modelo** = **família de distribuições**, diferentes valores de parâmetros retornam diferentes distribuições.
