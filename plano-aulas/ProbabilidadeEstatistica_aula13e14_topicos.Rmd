...
* Probabilidades estão associadas à áreas para v.a. contínuas.
    + A probabilidade de uma v.a. contínua assumir um particular valor é igual a zero, $P(X=x) = 0$ para todos $X \in \Omega_X$.
...
fx <- dnorm(x)
plot(x, fx, type = "l", ylim = c(0.016, 0.4))   # grafico da distribuicao de probabilidade
polygon( c( qnorm(1-0.01), qnorm(1-0.01), x[x > qnorm(1-0.01)], 3), c(0, dnorm(qnorm(1-0.01)), fx[x > qnorm(1-0.01)], 0), col="red")
```
