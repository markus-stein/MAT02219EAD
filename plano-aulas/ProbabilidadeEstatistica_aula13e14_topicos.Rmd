...
Definição **função densidade de probabilidade**: A função $f: \Omega_X \rightarrow  [0,1]$, dada por $f(x) = P(X=x)$, tal que $f(x) \geq 0$, para todo $x \in \Omega_X$, e $\int_{x \in \Omega_X} f(x) = 1$, é denominada função densidade de probabilidade.
