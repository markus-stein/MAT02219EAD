...
Definição **$v.a.$ contínua**: 
<!-- quando o espaço amostral associado a uma $v.a.$ assumir somente valores inteiros, finitos ou infinitos, $\Omega_X \subseteq \mathbb{Z}$, denominamos v.a. discreta. -->
