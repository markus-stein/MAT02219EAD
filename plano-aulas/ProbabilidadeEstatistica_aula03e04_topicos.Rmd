...
* Variáveis qualitativas: gráfico de barras, ou setores ("pizza");
...
* Gráficos: Título, nome nos eixos, ...
    + Trabalhos técnicos, monografias, ..., devem respeitar normas estabelecidas pela Associação Brasileira de Normas Técnicas (ABNT).
