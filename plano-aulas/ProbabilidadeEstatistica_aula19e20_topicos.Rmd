...
### Quiz 2-2
* Questão 1 e 2 necessitam encontrar valores da tabela `t` e qui-quadrado, porque em uma distribuição parece que procuramos valores unilaterais e em outra bilaterais, usamos $\alpha$ ou $\alpha/2$?  
...
* Questão 2 pede "intervalo de XX% de confiança para a variância populacional";
    ...
    + Nunca saberemos os valores dos **parâmetros** que são nosso alvo em inferência, assim usamos **estatísticas** e **intervalos de confiança** baseados nas estatísticas.