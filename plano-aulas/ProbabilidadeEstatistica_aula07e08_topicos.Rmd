...
**Exemplo 1**:Como calcuular uma distância percorrida sabendo a velocidade e o tempo de deslocamento de 
um objeto?
...
### Álgebra de Eventos ($\cup$, $\cap$, $A^c$ ou $\overline A$, ...)
* Operação entre conjuntos (RELEMBRAR!!!): `eventos = conjuntos`.
