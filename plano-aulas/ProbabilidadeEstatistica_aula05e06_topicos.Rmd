...
* Média aritmética: ponderada $\times$ simples;
    ...
    + para nós *média = média aritmética simples*
* Mediana
* Moda
...
### Medidas de dispersão (Seção 3.2, Livro Bussab e Morettin)
* Amplitude total
...
### Dados Não Agrupados $\times$ Dados* Frequências *por ponto* $\times$ *por intervalo*;
